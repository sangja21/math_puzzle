...
### 단원 9 — 적분 (`integral`)
- [x] 안건 선정 — 후보 2 면적 측량사 🎯 (+후보 1 분할 검증, 후보 6 아르키메데스 = 미션 2 곡선) — 2026-06-04
- [x] 구체 구현 계획서 — `09-integral.md` 결정 메모 채움 — 2026-06-04
- [x] 라이브러리 (`calculus.ts` 재사용) — `src/lib/puzzles/integral.ts` (미션 3종, 중점 합, 실진법 삼각형) — 2026-06-04
- [x] 페이지 + CSS (분할 슬라이더 / FTC 시각화) — 원리 탭 5섹션 + AreaSurvey 게임 탭 — 2026-06-04
- [x] 단원 8 ↔ 9 상호 링크 — §4 FTC 에서 롤러코스터 단원 본문 언급 (네비 링크는 마무리 작업에서 검토)
- [x] 메타 등록 — `integral`, 함수와 그래프, 🏛️ — 2026-06-04
- [x] 반응형 점검 — 768·480 CSS 포함
- [x] 시각 검증 — Playwright 헤드리스 (양 탭 + 미션1 전체 플로우 ⭐3 + JS 에러 0)
- [x] 커밋 — 본 커밋

## 2. 마무리 작업 (모든 단원 완료 후)

- [x] README.md 본문 갱신: 퍼즐 카운트(28→37), 신규 15개 퍼즐 표 추가, 함수와 그래프 10단원 섹션 신설 — 2026-06-07 `15469fc`
- [x] `principles/page.tsx` 함수 카테고리 섹션 정리 — 이미 lessonGroup 자동 그룹핑 완성, 추가 작업 불필요
- [x] 사이드바 그룹화 점검 — 상위 3개 링크(퍼즐/원리/코딩) 구조 확인, 이상 없음
- [x] `implementation_plan.md` 삭제 (폐기된 라이트 테마 계획서) — 2026-06-07 `15469fc`
- [x] `src/debug_sum.ts` 제거 — 2026-06-07 `15469fc`
- [x] 전체 다크모드 회귀 점검 — Next.js build 89페이지 전체 빌드 성공, TypeScript 에러 0 — 2026-06-07
